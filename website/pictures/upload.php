...
if (isset($_POST['tag']) && isset($_POST['name']) && isset($_FILES['pic']) && isset($_POST['price']) && isset($_POST['title']))
{
   ...
   else
   {
      ...
      $_POST['tag'] = preg_replace('/[^a-zA-Z0-9_]/', '', $_POST['tag']); // strip all except alphabets
      $_POST['tag'] = str_replace('..', '', $_POST['tag']); // remove dot dot ".."
      $_POST['tag'] = str_replace("/", "", $_POST['tag']); // replace "/" with "space"
